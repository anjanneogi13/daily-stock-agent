...
> **As of:** 2026-05-04 (post deep-audit fixes)
> **Status:** 1008 tests passing. All 9 faculties truly live.
...
|------|-------|---------|--------|----------|
| 1 | 5.5 | Backtester | 1.5-2 wks | Phases 9, 9.5, 10 |
| 2 | — | Faculty integration tests | 3-5 days | All future changes |
...
## Week 1 — Phase 5.5 BACKTESTER (foundation)
...
- New module: src/backtester.py
- Replay mode for news_signals.py + parallel_scorer.py
- CLI: python -m scripts.backtest --start 2025-08-01 --end 2026-04-30
- Output: data/backtests/<run_id>/ with picks, evals, equity curve
- Acceptance: reproduce last week's actual picks +/- 5%, runs <60s for 1mo

## Week 2 — Faculty integration tests

**Why second:** Locks in the 6 May 4 fixes + prevents same-pattern regressions.

- New: tests/test_faculty_integration.py (one suite per faculty)

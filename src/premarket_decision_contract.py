...
OFFICIAL_NO_PICK_ALLOWED_PRIMARY_CAUSES = {
    ...
    "NO_PICK_AGENT_PAUSED",  # P17.2: auto-pause guard skipped the official run
    "NO_PICK_DUPLICATE_ALREADY_LOGGED",  # P17.2: same-day multi-fire guard skipped a duplicate run

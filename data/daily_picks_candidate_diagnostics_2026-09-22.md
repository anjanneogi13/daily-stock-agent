...
- scored_count: **156**
- scored_not_filtered_count: **126**
- selected_pick_count: **2**
- selected_ticker_count: **2**
- universe_count: **519**

## Selected Official Picks
- WAT: score=**0.692**, action=**SAFE**, R:R=**1.67**
- DHR: score=**0.686**, action=**SAFE**, R:R=**1.67**

## Rejected Candidates
- AES: **hard_block** — SL too tight (0.6% < 2.5% for $15 stock)

...
1. X — score 85.0/100
   Source: news-signal | Window: unspecified
   Price levels: unavailable — quote lookup failed.
   Do not act without manually checking live price, spread, and news.
   Catalyst: TMX Group Q1 Adj. EPS $0.65 Beats $0.59 Estimate, Sales $488.200M Beat $481.833M Estimate
...
3. CCRN — Cross Country Healthcare, Inc. — score 100.0/100
   Source: news-signal | Window: intraday | Change: +29.38%
   Watch-only BUY/Entry: $13.08
   Watch-only SL: $12.88
   Watch-only TP: $13.47
   R/R: 1.95
   Catalyst: Knox Lane To Acquire All Outstanding Shares Of Cross Country Healthcare Common Stock For $13.25/Shr In All-Cash Transaction Valued At $437M
   WATCH ONLY — do not treat as an official pick or buy instruction.
